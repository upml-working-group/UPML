...
public class UPMLParsingException extends RuntimeException {
     ...
     */
    UPMLParsingException(String message, Integer characterNum, Integer lineNum) {
     ...
     * @param message Human-readable error message.
     */
    UPMLParsingException(String message) {
